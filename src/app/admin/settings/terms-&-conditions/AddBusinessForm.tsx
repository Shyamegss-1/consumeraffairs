...
import { handleCreateUpdateTermsAndConditions } from "@/server-actions/Admin/TermsAndConditions";
...
const AddBusinessForm = ({ userId, footerData }: Props) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const res = await handleCreateUpdateTermsAndConditions({ content, id });
      setLoading(false);
      if (!res.status) {
