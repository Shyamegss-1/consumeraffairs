    ...
    <AuthLayout>
      <div className="bnr-cnt ca-bg-pttrn-hxgn ca-bg-pttrn-hxgn--bttm-rght ca-bg-pttrn-hxgn--lg">
        <div className="crd login ">
          ...
          <div
            id="g_id_onload"
            data-client_id="170937053203-u4ja9i3j32k57mmctic5cl3b7vvk3ae2.apps.googleusercontent.com"
        ...
        <ul className="ftr ca-list ca-list--clr">
          <li className="ftr__itm">
            <a
              href="https://www.consumeraffairs.com/about/privacy_policy/"
              className="ftr__lnk ca-a ca-a--no-undln ca-a--cr"
            >
              Privacy Policy
            </a>
          </li>
          <li className="ftr__itm">
            <a
              href="https://www.consumeraffairs.com/about/contact"
              className="ftr__lnk ca-a ca-a--no-undln ca-a--cr"
            >
              Contact Us
            </a>
          ...
          <li className="ftr__itm">
            <a
              href="https://www.consumeraffairs.com/about/terms_of_use/"
              className="ftr__lnk ca-a ca-a--no-undln ca-a--cr"
            >
              Terms of Use
            </a>
