...
const MainDashboardLayout = async ({ user }: Props) => {
    ...
    <>
      <section className="user-name-sec">
        <div className="text-center">
          <h2>
            Hi, <span>{businessUser?.firstName}</span>
          </h2>
              ...
              <div className="grid grid-cols-12">
                  ...
                  <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-8 ">
                      <h1 className="text-2xl font-semibold text-active_dark">
                        {businessUser?.userDetails?.companyName}
                      </h1>
                ...
                <div className="col-span-12 p-5">
                  <h2 className="text-lg flex justify-start items-center gasize-2 p-1 mt-2">
                    ...
                    <span className="font-bold text-active_dark ml-2">
                      Domain :
                    </span>
                    <span className="ml-2">
                      {businessUser?.userDetails?.website}
                    </span>
                  </h2>
                  <h2 className="text-lg flex justify-start items-center gap-2 mt-2">
                    ...
                    <span className="">
                      {businessUser?.userDetails?.jobTitle}
                    </span>
                  </h2>
                  <h2 className="text-lg flex justify-start items-center gap-2 mt-2">
                    <svg
                    ...
                    <span className="">{businessUser?.userDetails?.phone}</span>
                  </h2>
                  <h2 className="text-lg flex justify-start items-center gap-2 mt-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="">
                      {businessUser?.userDetails?.address}
                    </span>
                  </h2>
                  <h2 className="text-lg flex justify-start items-center gap-2 mt-2">
                    <svg
                    ...
                    <span className="">{businessUser?.email}</span>
                  </h2>
                </div>
                  ...
                  <div className="col-span-6">
                    <div className="review-info pt-4">
                      ...
                      <p className="m-0 font-medium text-gray-500 my-2">
                        <span className="bg-[#5247A5] size-0.5 px-2.5 m-2 rounded-sm"></span>
                        Under Moderation
                      </p>
                      <p className="m-0 font-medium text-gray-500 my-2">
                        <span className="bg-[#141414] size-0.5 px-2.5 m-2 rounded-sm"></span>
                        Reported Reviews
                      </p>
                      <p className="m-0 font-medium text-gray-500 my-2">
                        <span className="bg-[#8478DF] size-0.5 px-2.5 m-2 rounded-sm"></span>
                        Removed Reviews
                      </p>
                    </div>
                  </div>
...
export const LoadingUi = () => {
  return (
    <>
      <section className="user-name-sec">
        <div className="text-center">
          <h2 className="min-h-10 max-w-96 mx-auto bg-primary_dark/15 rounded-lg animate-pulse"></h2>
          <p className="min-h-5 max-w-96 mx-auto bg-primary_dark/15 rounded-lg animate-pulse mt-4"></p>
        </div>
      </section>
      <div className="min-w-screen-2xl mx-auto px-10 py-5">
        <div className="w-full grid grid-cols-3 gap-5">
          <div className="col-span-3 md:col-span-1 ">
            <div className="bg-white rounded-lg shadow-md border">
              <div className="grid grid-cols-12">
                <div className="col-span-12 p-5">
                  <div className="grid grid-cols-12">
                    <div className="col-span-4 flex justify-center items-center bg-primary_dark/15 animate-pulse rounded-md size-40"></div>
                    <div className="col-span-8 ">
                      <h1 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse"></h1>
                      <h4 className="text-xl font-semibold flex justify-start items-center mt-4 gap-4">
                        <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse"></span>
                        <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse"></span>
                      </h4>
                    </div>
                  </div>
                ...
                <div className="col-span-12 p-5">
                  <h2 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse p-1 mt-2"></h2>
                  <h2 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-2"></h2>
                  <h2 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-2"></h2>
                  <h2 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-2"></h2>
                  <h2 className="min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-2"></h2>
                </div>
                <div className="grid grid-cols-2 gap-5 col-span-12 p-5">
                  <div className="min-h-10  bg-primary_dark/15  animate-pulse font-semibold w-full text-center py-2 rounded-lg"></div>
                  <div className="min-h-10  bg-primary_dark/15  animate-pulse font-semibold w-full text-center py-2 rounded-lg"></div>
                </div>
              </div>
            </div>
            ...
            <div className="h-full grid grid-rows-12 gap-5">
              <div className="bg-white  row-span-6 rounded-lg shadow-md border p-4">
                <div className="grid grid-cols-12 h-full gap-4">
                  <div className="col-span-6">
                    <div className="review-info pt-4 fle">
                      <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse"></span>
                      <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-4"></span>
                      <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-4"></span>
                      <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse mt-4"></span>
                    </div>
                  </div>
                  <div className="col-span-6 ">
                    <div className="w-full h-full flex justify-center items-center rounded-lg min-h-10  bg-primary_dark/15  animate-pulse"></div>
                  </div>
                </div>
              </div>
              <div className="bg-white  row-span-6 rounded-lg shadow-md border p-4">
          ...
          <div className="col-span-3 md:col-span-1 ">
            <div className="h-full grid grid-rows-12 gap-5">
              <div className="bg-white row-span-3 rounded-lg shadow-md border py-4 px-6 flex justify-between items-center gap-5">
                <span className="flex justify-start items-center min-h-10 w-[80%] bg-primary_dark/15 rounded-lg animate-pulse"></span>
                <span className="flex justify-start items-center min-h-10 w-[20%] bg-primary_dark/15 rounded-lg animate-pulse"></span>
              </div>
              <div className="bg-white  row-span-9 rounded-lg shadow-md border p-4">
              <span className="flex justify-start items-center min-h-10 w-full bg-primary_dark/15 rounded-lg animate-pulse"></span>
                <hr className="w-full h-0.5 bg-active_dark mt-4" />
